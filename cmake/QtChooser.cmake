if(WIZNOTE_USE_QT5)
    find_package(Qt5 REQUIRED Core Widgets LinguistTools Xml Network WebKit WebKitWidgets Concurrent printsupport)
    ...
    if(APPLE)
        find_package(Qt4 REQUIRED QtCore QtGui QtXml QtNetwork QtWebKit printsupport)
    else(APPLE)
        find_package(Qt4 REQUIRED QtCore QtGui QtXml QtNetwork QtWebKit printsupport)
    endif(APPLE)
...
macro(qt_use_modules)
    if(WIZNOTE_USE_QT5)
        if(APPLE)
            qt5_use_modules(${ARGV0} Core Gui Widgets Xml Network WebKit WebKitWidgets Concurrent MacExtras printsupport)
        else(APPLE)
            qt5_use_modules(${ARGV0} Core Gui Widgets Xml Network WebKit WebKitWidgets Concurrent printsupport)
        endif(APPLE)
    else(WIZNOTE_USE_QT5)
