if(WIZNOTE_USE_QT5)
    find_package(Qt5 REQUIRED Core Widgets LinguistTools Xml Network WebKit WebKitWidgets Quick PrintSupport Concurrent)
...
macro(qt_use_modules)
    if(WIZNOTE_USE_QT5)
        if(APPLE)
            qt5_use_modules(${ARGV0} Core Gui Widgets Xml Network WebKit WebKitWidgets Quick  PrintSupport Concurrent MacExtras)
        else(APPLE)
            qt5_use_modules(${ARGV0} Core Gui Widgets Xml Network WebKit WebKitWidgets Quick PrintSupport Concurrent)
        endif(APPLE)
    else(WIZNOTE_USE_QT5)
