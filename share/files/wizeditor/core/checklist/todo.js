...
function WizTodoWindowsHelper(external) {
	...
	function getCheckedImageFileName() {
		return this.wizEditor.AppPath + "WizTools\\htmleditor\\core\\checklist\\checked.png";
	}

	function getUnCheckedImageFileName() {
		return this.wizEditor.AppPath + "WizTools\\htmleditor\\core\\checklist\\unchecked.png";
	}
