...
var WizEditor = {
    ...
    isModified: function () {
        ...
        curHtml = domUtils.removeDomByTagFromHtml(curHtml, CONST.TAG.CODE_MIRROR);
        originalHtml = domUtils.removeDomByTagFromHtml(originalHtml, CONST.TAG.CODE_MIRROR);
...
},{"../common/const":18,"../common/env":20}],10:[function(require,module,exports){
/**
...
},{"./const":18,"./lang":22}],21:[function(require,module,exports){
/**
 * undo、redo 工具包
 */
...
domUtils.getContentHtml = function (options) {
    ...
    var editingImgExp;
    if (!isSaveTemp) {
        editingImgExp = new RegExp('(<img[^<>]*)( ' + CONST.ATTR.IMG_EDITING + '=(\'|")1\\3)', 'ig');
        content = content.replace(editingImgExp, '$1');
    }
...
var editor = {
    ...
    on: function () {
        ...
        codeCore.loadDependency(callback);
...
function getStyle (start) {
    ...
    while (obj && obj !== ENV.doc.body) {
        if (obj.nodeType === 1) {
            analyseStyle(obj, styleList, styleResult);
        }
        obj = obj.parentNode;
    }
...
function initTargetList() {
    targetList = ENV.doc.querySelectorAll(CONST.TAG.TMP_HIGHLIGHT_TAG);
...
var _event = {
    ...
    handler: {
        onClick: function (e) {
            if (ENV.readonly &&
                (ENV.client.type.isIOS || ENV.client.type.isAndroid)) {
                clickImgForRead(e);
            } else if (!ENV.readonly && ENV.client.type.isAndroid) {
                clickImgForEdit(e);
            }
        }
    }
