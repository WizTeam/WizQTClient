...
},{"base64-js":3,"ieee754":2,"isarray":1}],5:[function(require,module,exports){
...
var WizEditor = {
    ...
    off: function (options, callback) {
        ...
        if (ENV.win.WizReader) {
            ENV.win.WizReader.on(options, callback);
        }
    ...
    isModified: function () {
        ...
        //     console.log('\n\n\n---------------------------------------------------------------------------------------------------------------------------\n\n\n');
        // }
        return ENV.readonly === false && domUtils.getContentHtml() != editor.getOriginalHtml();
    },
    /**
     * 修改光标选中文本的样式 和 属性
    ...
    img: {
        ...
        insertAsAttachment: function (guid, imgPath) {
            ...
            editor.insertHtml(imgHtml, true);
        },
...
},{"./amend/amend":7,"./common/base64":14,"./common/env":17,"./common/historyUtils":18,"./common/wizStyle":22,"./domUtils/domExtend":26,"./editor/base":27,"./editor/editorEvent":28,"./imgUtils/imgUtils":32,"./linkUtils/linkUtils":33,"./nightMode/nightModeUtils":37,"./rangeUtils/rangeExtend":39,"./tableUtils/tableCore":42,"./todoUtils/todoCore":47}],6:[function(require,module,exports){
var ENV = require('./common/env'),
...
var WizReader = {
    ...
    on: function (options, callback) {
        ...
        if (ENV.options.noteType == CONST.NOTE_TYPE.MARKDOWN) {
            WizReader.markdown(callback);
        } else if (ENV.options.noteType == CONST.NOTE_TYPE.MATHJAX) {
            WizReader.mathJax(callback);
        } else {
            setTimeout(function() {
                if (typeof callback === 'function') {
                    callback();
...
},{"./amend/amendInfo":8,"./amend/amendUser":9,"./common/base64":14,"./common/const":15,"./common/env":17,"./common/utils":21,"./common/wizStyle":22,"./highlightUtils/highlightUtils":30,"./imgUtils/imgUtils":32,"./markdown/markdownRender":36,"./nightMode/nightModeUtils":37,"./reader/base":40,"./todoUtils/todoCore":47}],7:[function(require,module,exports){
/**
 * 修订功能 专用工具包
 */
...
var ENV = require('../common/env'),
    ...
    historyUtils = require('../common/historyUtils'),
    rangeUtils = require('../rangeUtils/rangeExtend'),
    wizBlockUtils = require('../wizBlockUtils/wizBlockUtils'),
    tableCore = require('../tableUtils/tableCore'),
...
var amend = {
     ...
     */
    getFragmentForCopy: function (isCut) {
        var range = rangeUtils.getRange(),
            tmpParent, fragment = null;
        //无光标时， 不操作任何内容
...
//                  console.log(endDom.nodeValue);
    ...
    onKeyDownReverse: function (e) {
        ...
        wizBlockUtils.insertEmptyLine(check.tableContainer, check.after);
...
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/lang":19,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"../tableUtils/tableCore":42,"../tableUtils/tableUtils":45,"../todoUtils/todoCore":47,"../wizBlockUtils/wizBlockUtils":51,"./amendInfo":8,"./amendUser":9,"./amendUtils/amendExtend":11}],8:[function(require,module,exports){
/**
 * 修订信息显示图层 相关对象
 */
...
},{"../common/const":15,"../common/env":17,"../common/lang":19,"../common/utils":21,"../common/wizUserAction":23,"../domUtils/domBase":25,"./amendUser":9,"./amendUtils/amendBase":10}],9:[function(require,module,exports){
/**
 * 用于记录 当前操作者的信息
...
},{"../common/const":15,"../common/env":17}],10:[function(require,module,exports){
/**
...
},{"../../common/const":15,"../../common/env":17,"../../common/utils":21,"../../domUtils/domBase":25,"../../rangeUtils/rangeBase":38}],11:[function(require,module,exports){
/**
...
module.exports = amendUtils;
},{"../../common/const":15,"../../common/env":17,"../../common/utils":21,"../../domUtils/domExtend":26,"../../rangeUtils/rangeExtend":39,"./../amendUser":9,"./amendBase":10}],12:[function(require,module,exports){
/**
 * 代码区域操作核心包 core
 */
var ENV = require('../common/env'),
...
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"./codeUtils":13}],13:[function(require,module,exports){
/**
 * 代码区域操作的基本方法集合
 */
var ENV = require('./../common/env'),
...
},{"../rangeUtils/rangeExtend":39,"./../common/const":15,"./../common/env":17,"./../common/utils":21,"./../domUtils/domExtend":26}],14:[function(require,module,exports){
/*
...
},{"./scriptLoader":20,"./utils":21}],17:[function(require,module,exports){
/**
    ...
    dependency: {
        files: {
            ...
            js: {
                ...
                mathJax: '{dependencyUrl}/mathjax/MathJax.js?config=TeX-MML-AM_SVG'
                // mathJax: 'http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-MML-AM_SVG'
            },
            init: function () {
...
},{"./const":15,"./lang":19}],18:[function(require,module,exports){
/**
 * undo、redo 工具包
 */
...
//            console.log('redo: ' + historyUtils.stackIndex);
     ...
     */
    saveSnap: function (keepIndex) {
        if (!historyUtils.enable ||
            CONST.COMPOSITION_START) {
            return;
        }
...
//                console.log(snap.content);
    ...
    restore: function (snap) {
        ...
        var sel = ENV.doc.getSelection(), start, end;
...
},{"./../domUtils/domExtend":26,"./../rangeUtils/rangeExtend":39,"./const":15,"./env":17,"./utils":21}],19:[function(require,module,exports){
/**
...
},{"./const":15}],22:[function(require,module,exports){
/**
 * 默认的样式集合
 */
var ENV = require('./env'),
...
var TmpEditorStyle = {
    ...
    DefaultStyle = {
        ...
        'line-height: 1.6;' +
        'margin: 0;padding: 20px 15px;padding: 1.33rem 1rem;' +
        '}' +
        ...
        'body {line-height:1.7;padding:0.75rem 0.9375rem;color:#353c47;}' +
        ...
        '}',
        todoList: '.wiz-todo-main {padding-left: 12px;position: relative;line-height:30px;}' +
    ...
    BodyStyle = 'html {height:100%;} body {min-height:100%;box-sizing:border-box;}',
    ...
    CodeStyle = 'body pre.prettyprint {padding:0;}' +
    ...
    TableScroll = '.wiz-table-scroll::-webkit-scrollbar {width: 7px;height: 7px;}' +
        '.wiz-table-scroll::-webkit-scrollbar-thumb {background-color: #7f7f7f;border-radius: 7px;}' +
        '.wiz-table-scroll::-webkit-scrollbar-button {display: none;}',
...
var WizStyle = {
    ...
    insertTmpEditorStyle: function () {
        ...
        if (ENV.client.type.isMac) {
            WizStyle.insertStyle({name: CONST.NAME.TMP_STYLE}, TableScroll);
        }
    },
    insertTmpReaderStyle: function () {
        WizStyle.insertStyle({name: CONST.NAME.TMP_STYLE},
            BodyStyle + TableContainerStyle + CodeStyle);
...
},{"../domUtils/domBase":25,"./const":15,"./env":17}],23:[function(require,module,exports){
/**
 * 专门用于记录用户行为的 log
 */
var ENV = require('../common/env');
...
},{"../common/env":17}],24:[function(require,module,exports){
/**
...
var domUtils = {
    ...
    clone: function (dom, excludeInner) {
        var result, tmp, attList, atts, i, j, k, v;
        if (!dom) {
            return null;
        }
        if (excludeInner) {
     ...
     * @returns {*}
     */
    getDomByIndexList: function (indexList) {
     ...
     * @returns {{}}
     */
    getDomListA2B: function (options) {
     ...
     * @returns {Array}
     */
    getIndexListByDom: function (dom) {
        var e = dom, indexList = [];
    ...
    packageByDiv: function (dom) {
        ...
        while (start) {
            ...
            if (!tmp || domUtils.isBlockDom(tmp)) {
                break;
            }
            start = tmp;
        }
     ...
     * @returns {string}
     */
    removeStyleByNameFromHtml: function (html, name) {
        var regStyle = new RegExp('<style( ([^<>])+[ ]+|[ ]+)name *= *[\'"]' + name + '[\'"][^<>]*>[^<]*<\/style>', 'ig');
        var regLink = new RegExp('<link( ([^<>])+[ ]+|[ ]+)name *= *[\'"]' + name + '[\'"][^<>]*>', 'ig');
     ...
     * @returns {string}
     */
    removeDomByTagFromHtml: function (html, tag) {
...
},{"./../common/const":15,"./../common/env":17,"./../common/utils":21}],26:[function(require,module,exports){
/**
 * DOM 操作工具包（扩展类库）
 */
...
domUtils.getPrevBlock = function (tmpStart) {
    var isPre = false, tmp;
    if (domUtils.isBlockDom(tmpStart) || domUtils.isTag(tmpStart, 'br')) {
        return tmpStart;
    }
    while (tmpStart) {
...
domUtils.getNextBlock = function (tmpEnd) {
    ...
    while (tmpEnd) {
        ...
        if (domUtils.isBlockDom(tmpEnd) || domUtils.isTag(tmpEnd, 'br')) {
            break;
        }
    }
    return tmpEnd;
...
module.exports = domUtils;
},{"./../common/const":15,"./../common/env":17,"./domBase":25}],27:[function(require,module,exports){
/**
 * 编辑器 基础工具包
 */
var ENV = require('../common/env'),
    ...
    domUtils = require('../domUtils/domExtend'),
    rangeUtils = require('../rangeUtils/rangeExtend'),
    wizBlockCore = require('../wizBlockUtils/wizBlockCore'),
    todoCore = require('../todoUtils/todoCore'),
...
var editor = {
    ...
    insertDom: function (dom, notInsertEmptyDiv) {
        if (!dom) {
            return;
        }
        ...
        if (notInsertEmptyDiv && domUtils.isEmptyDom(tmpDom.parent) && !tmpDom.target) {
...
},{"../amend/amend":7,"../amend/amendUser":9,"../amend/amendUtils/amendExtend":11,"../codeUtils/codeCore":12,"../common/const":15,"../common/dependLoader":16,"../common/env":17,"../common/historyUtils":18,"../common/utils":21,"../common/wizStyle":22,"../domUtils/domExtend":26,"../imgUtils/imgUtils":32,"../rangeUtils/rangeExtend":39,"../tableUtils/tableCore":42,"../tableUtils/tableUtils":45,"../tableUtils/tableZone":46,"../todoUtils/todoCore":47,"../wizBlockUtils/wizBlockCore":50,"./editorEvent":28,"./tabKey":29}],28:[function(require,module,exports){
/**
 * editor 使用的基本事件处理
 */
var ENV = require('../common/env'),
...
function copySelection(e, isCut) {
    var zone = tableZone.getZone(),
        range = rangeUtils.getRange(),
        fragment, oldHtml, newHtml, canSetData = true,
        user, style, domList = [];
    isCut = !!isCut;
...
function clearClipHtml(html) {
    ...
    var tmpTag, tmpIndex, i, j;

    for (i=0, j=startTag.length; i<j; i++) {
        tmpTag = startTag[i];
        tmpIndex = html.indexOf(tmpTag);
        if (tmpIndex > -1) {
            html = html.substr(tmpIndex + tmpTag.length);
            break;
        }
    }
    for (i=0, j=endTag.length; i<j; i++) {
        ...
        tmpIndex = html.indexOf(tmpTag);
        if (tmpIndex > -1) {
            html = html.substr(0, tmpIndex);
        }
    }

    html = domUtils.clearStyleFromHtml(html, ['color', 'font-weight', 'font-style', 'text-decoration']);
    return html;
}
function pasteFromClipBoard(e) {
    ...
    if (zone.table && zone.range) {
        // 在表格内粘贴
        if (html) {
            template = tableUtils.getTemplateByHtmlForPaste(clearClipHtml(html));
        ...
        if (!template.isTable) {
            ...
            if (range) {
                ...
                if (tmpTarget) {
                    tmpTarget.parentNode.removeChild(tmpTarget);
                }
...
},{"../amend/amend":7,"../amend/amendUser":9,"../amend/amendUtils/amendExtend":11,"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/lang":19,"../common/utils":21,"../domUtils/domBase":25,"../rangeUtils/rangeExtend":39,"../tableUtils/tableCore":42,"../tableUtils/tableUtils":45,"../tableUtils/tableZone":46}],29:[function(require,module,exports){
/**
 * tab 键操作处理
 */
var ENV = require('../common/env'),
...
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39}],30:[function(require,module,exports){
/**
 * 超链接操作基本方法集合
 */
var ENV = require('./../common/env'),
...
var highlightUtils = {
    on: function (keyList) {
        ...
        for (i = 0, j = keyList.length; i < j; i++) {
            highlightUtils.highlight(keyList[i]);
        }
    },
    off: function () {
    ...
    highlight: function (key) {
        ...
        while (ENV.win.find(key, false, true)) {
            span = document.createElement(CONST.TAG.TMP_HIGHLIGHT_TAG);
...
},{"./../common/const":15,"./../common/env":17,"./../domUtils/domExtend":26,"./../rangeUtils/rangeExtend":39}],31:[function(require,module,exports){
/**
 * img 操作基本方法集合
 */
...
function initImage(img) {
    ...
    curImg = img;
    rangeUtils.setRange(img.parentNode, domUtils.getDomIndex(img) + 1);
}
    ...
    handler: {
        ...
        onKeyDown: function (e) {
            ...
            if (curImg && (keyCode === 8 || keyCode === 46)) {
                ...
                if (start) {
                    startOffset = domUtils.getDomIndex(curImg);
...
},{"../rangeUtils/rangeExtend":39,"./../common/const":15,"./../common/env":17,"./../common/utils":21,"./../domUtils/domExtend":26}],32:[function(require,module,exports){
/**
 * img 操作基本方法集合
 */
...
var imgUtils = {
    ...
    makeAttachmentHtml: function (guid, imgPath) {
...
},{"./../common/env":17,"./imgResize":31}],33:[function(require,module,exports){
/**
 * 超链接操作基本方法集合
 */
var ENV = require('./../common/env'),
...
},{"./../common/const":15,"./../common/env":17,"./../domUtils/domExtend":26,"./../rangeUtils/rangeExtend":39}],34:[function(require,module,exports){
"use strict";
var Markdown;
...
var Render = {
    ...
    getDependencyFiles: function (type, id) {
    ...
    xssFilter: (function () {
        ...
        var hrefFileSrc = '#';
        var hrefFileReg = new RegExp('^(' + hrefFileSrc + fileName + ')', 'i');

        var tagAttrReg = /^(id|class|style|data|width|height)/i;
...
},{"./../common/dependLoader":16,"./../common/env":17,"./../common/scriptLoader":20,"./../common/utils":21,"./../common/xss":24,"./Markdown.Converter":34,"./Markdown.Extra":35}],37:[function(require,module,exports){
/**
 * 夜间模式的基本方法集合
 */
...
},{"../common/const":15,"../common/env":17,"../common/wizStyle":22,"../domUtils/domBase":25}],38:[function(require,module,exports){
/**
 * 范围操作的基本方法集合
 */
...
var rangeUtils = {
    ...
    getRangeDomList: function (options) {
        ...
        var list = domUtils.getDomListA2B({
            startDom: startDom,
            startOffset: startOffset,
            endDom: endDom,
            endOffset: endOffset,
...
},{"./../common/base64":14,"./../common/const":15,"./../common/env":17,"./../domUtils/domBase":25}],39:[function(require,module,exports){
/**
 * 范围操作的基本方法集合
 */
...
module.exports = rangeUtils;
},{"./../common/const":15,"./../common/env":17,"./../common/utils":21,"./../domUtils/domExtend":26,"./rangeBase":38}],40:[function(require,module,exports){
/**
 * 阅读器 基础工具包
 */
var ENV = require('../common/env'),
...
},{"../common/const":15,"../common/env":17,"../common/wizStyle":22,"../domUtils/domExtend":26,"../tableUtils/tableCore":42,"../todoUtils/todoCore":47,"./readerEvent":41}],41:[function(require,module,exports){
/**
 * editor 使用的基本事件处理
 */
var ENV = require('../common/env'),
...
function clickImg(e) {
    var target = e.target;
    if (!target || !domUtils.isTag(target, 'img') ||
        /(wiz-img-cannot-drag)|(wiz-todo)/i.test(target.className) ||
        !target.src) {
        return;
    }
...
},{"../common/const":15,"../common/env":17,"../common/utils":21,"../domUtils/domExtend":26,"../imgUtils/imgUtils":32}],42:[function(require,module,exports){
/**
 * 表格操作核心包 core
 */
var ENV = require('../common/env'),
    ...
    tableScroll = require('./tableScroll'),
...
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"./tableMenu":43,"./tableScroll":44,"./tableUtils":45,"./tableZone":46}],43:[function(require,module,exports){
/*
 表格菜单 控制
 */
var ENV = require('../common/env'),
...
},{"../common/const":15,"../common/env":17,"../common/lang":19,"../domUtils/domExtend":26,"./tableUtils":45,"./tableZone":46}],44:[function(require,module,exports){
/*
 表格菜单 控制
 */
var ENV = require('../common/env'),
...
var checkTimer,scrollTimer;
function checkStart() {
    if (checkTimer) {
        clearTimeout(checkTimer);
    }
    checkTimer = setTimeout(checkTables, 100);
}
...
function checkTables() {
    ...
    for (i = _tableList.length - 1; i >= 0; i--) {
        ...
        tableList.push({
            table: table,
            tableBody: tableContainer.querySelector('.' + CONST.CLASS.TABLE_BODY),
...
function checkScroll() {
    ...
    for (i = tableList.length - 1; i >= 0; i--) {
        tableObj = tableList[i];
        if (tableObj.top < viewTop &&
            tableObj.top + tableObj.height > viewTop &&
            tableObj.tableBody.offsetWidth < tableObj.tableBody.scrollWidth) {
            showDiyScroll(tableObj);
        } else {
            hideDiyScroll(tableObj);
        }
    }
}

function hideDiyScroll(tableObj) {
    var scroll = tableObj.tableBody.parentNode.querySelector('.' + CONST.CLASS.TABLE_SCROLL);
    if (scroll) {
        scroll.style.display = 'none';
        _event.unbindScroll(tableObj.tableBody, scroll);
    }
}
function showDiyScroll(tableObj) {
    var scroll, scrollInner;
    scroll = tableObj.tableBody.parentNode.querySelector('.' + CONST.CLASS.TABLE_SCROLL);
    if (scroll) {
        ...
        domUtils.addClass(scroll, CONST.CLASS.TABLE_SCROLL);
    }

    domUtils.css(scrollInner, {
        "width": tableObj.tableBody.scrollWidth + "px",
        "height": "1px",
    ...
    domUtils.css(scroll, {
        "background-color": "rgba(255, 255, 255, 0.2)",
        "height": "17px",
        "width": tableObj.tableBody.offsetWidth + "px",
        "overflow-x": "scroll",
        "overflow-y": "hidden",
        "position":"fixed",
        "bottom": "0px",
    ...
    scroll.scrollLeft = tableObj.tableBody.scrollLeft;
    domUtils.after(scroll, tableObj.tableBody);
    _event.bindScroll(tableObj.tableBody, scroll);
}
...
var _event = {
    ...
    bindScroll: function(tableBody, scroll) {
        _event.unbindScroll(tableBody, scroll);
        scroll.addEventListener('scroll', _event.handler.onSxScroll);
        tableBody.addEventListener('scroll', _event.handler.onTxScroll);
    },
    unbind: function () {
        ENV.event.remove(CONST.EVENT.ON_SCROLL, _event.handler.onScroll);
    ...
    unbindScroll: function(tableBody, scroll) {
        scroll.removeEventListener('scroll', _event.handler.onSxScroll);
        tableBody.removeEventListener('scroll', _event.handler.onTxScroll);
    },
    handler: {
        onScroll: function () {
            scrollStart();
        },
        onSxScroll: function (e) {
            var scroll = e.target;
            var tableBody = e.target.parentNode.querySelector('.' + CONST.CLASS.TABLE_BODY);
            tableBody.scrollLeft = scroll.scrollLeft;
        },
        onTxScroll: function (e) {
            var tableBody = e.target;
            var scroll = e.target.parentNode.querySelector('.' + CONST.CLASS.TABLE_SCROLL);
            scroll.scrollLeft = tableBody.scrollLeft;
        },
...
module.exports = tableScroll;
},{"../common/const":15,"../common/env":17,"../common/lang":19,"../domUtils/domExtend":26,"./tableUtils":45,"./tableZone":46}],45:[function(require,module,exports){
/**
 * 表格操作的基本方法集合
 */
var ENV = require('./../common/env'),
...
},{"../rangeUtils/rangeExtend":39,"./../common/const":15,"./../common/env":17,"./../common/utils":21,"./../domUtils/domExtend":26}],46:[function(require,module,exports){
/*
 表格选择区域 控制
 */
var ENV = require('../common/env'),
...
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"./tableUtils":45}],47:[function(require,module,exports){
/**
 * todolist 操作核心包 core
 */
var ENV = require('../common/env'),
...
var patchForReader = {
    ...
    addModifiedId: function (obj) {
        if (!ENV.readonly) {
            return;
        }
        var checkList, i, checkItem;
        // 制作 map 主要用于 之前的 bug 产生 无 id 的 checkbox
        if (!patchForReader.modifiedIdMap) {
            patchForReader.modifiedIdMap = {};
            checkList = ENV.doc.querySelectorAll('.' + CONST.CLASS.TODO_CHECKBOX);
            for (i = 0; i < checkList.length; i++) {
                checkItem = checkList[i];
                patchForReader.modifiedIdMap[checkItem.id] = i;
            }
        }
        ...
        for (k in patchForReader.modifiedIdList) {
            if (patchForReader.modifiedIdList.hasOwnProperty(k)) {
                idList.push({
                    ...
                    index: patchForReader.modifiedIdMap[k]
                });
            }
        }
        return idList;
    ...
    modifyDoc: function () {
        ...
        var _document = ENV.doc,
            ...
            i, id, checked, index, checkList, checkbox, main;
        ...
        onKeyDown: function (e) {
            ...
            if (main) {
                if (range.startContainer == main && range.startOffset !== domUtils.getEndOffset(main)) {
                    ...
                    (range.startOffset !== domUtils.getEndOffset(range.startContainer) || range.startContainer.nextSibling)) {
                    isInMain = true;
                }
            }
            ...
            if (!isEmpty) {
                ...
                mainParentTag = (container == ENV.doc.body || !domUtils.isBlockDom(container)) ? 'div' : container.tagName;
        ...
        onSelectionChange: function (e) {
            ...
            if (isBefore.enable) {
                ...
                if (checkbox && checkbox.nextSibling) {
                    ...
                    endOffset = domUtils.getDomIndex(checkbox) + 1;
                }
...
},{"../common/const":15,"../common/env":17,"../common/utils":21,"../common/wizStyle":22,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"./todoRouteForClient":48,"./todoUtils":49}],48:[function(require,module,exports){
/**
 * todolist 客户端适配接口
 */
var ENV = require('../common/env'),
...
},{"../common/base64":14,"../common/env":17}],49:[function(require,module,exports){
/**
 * todolist 基本工具包
 */
var ENV = require('../common/env'),
...
var todoUtils = {
    ...
    checkTodo: function (checkImg, todoRoute) {
        var result = {
            id: '',
            checked: false
        };
    ...
    cloneTodo: function (container) {
        ...
        while (tmp && tmp.childNodes && tmp.childNodes.length) {
            ...
            if (last.nodeType === 3 && last.nodeValue.replace(CONST.FILL_CHAR_REG, '').length === 0) {
    ...
    fixCheckbox: function (checkItem, isForOld) {
        ...
        domUtils.attr(checkItem, {'style': null});
    ...
    fixMain: function (main) {
        ...
        if (parent && parent !== main.parentNode) {
    ...
    fixNewTodo: function (targetTodo) {
        ...
        for (i = 0; i < todoList.length; i++) {
            ...
            if (todoUtils.isTodoTag(subParent)) {
                start = subTodoItem;
            } else {
                start = subParent;
            }
    ...
    getMainByCaret: function () {
        ...
        return todoUtils.getMainFromChild(end);
        //
    ...
    getMainHtml: function () {
        var str = '<span class="' + CONST.CLASS.TODO_MAIN + ' ' + CONST.CLASS.TODO_UNCHECKED + '">' +
            '<input readonly id="%1" class="' + CONST.CLASS.TODO_CHECKBOX + ' ' + CONST.CLASS.IMG_NOT_DRAG + '" ' +
    ...
    setTodo: function (container, todoRoute) {
        var range = rangeUtils.getRange(), rangeList, start, end,
        ...
        if (container) {
            ...
            domUtils.packageByDiv(rangeList.startDom);
...
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/lang":19,"../common/wizStyle":22,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"./../common/base64":14}],50:[function(require,module,exports){
/**
 * 代码区域操作核心包 core
 */
var ENV = require('../common/env'),
    ...
    rangeUtils = require('../rangeUtils/rangeExtend'),
    historyUtils = require('../common/historyUtils'),
    wizBlockUtils = require('./wizBlockUtils');
...
var _event = {
    ...
    handler: {
        onMouseDown: function (e) {
            ...
            wizBlockUtils.checkAndInsertEmptyLine(e);
        }
    }
};
...
module.exports = wizBlockCore;
},{"../common/const":15,"../common/env":17,"../common/historyUtils":18,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"./wizBlockUtils":51}],51:[function(require,module,exports){
/**
...
function getBlockFun(obj) {
    return domUtils.hasClass(obj, CONST.CLASS.CODE_CONTAINER_OLD) ||
...
var wizBlockUtils = {
    ...
    checkAndInsertEmptyLine: function (e) {
        ...
        if (container && (isAfter || isBefore)) {
            wizBlockUtils.insertEmptyLine(container, isAfter);
        } else {
            dom = null;
        }
    },
...
module.exports = wizBlockUtils;
},{"../common/const":15,"../common/env":17,"../common/utils":21,"../domUtils/domExtend":26,"../rangeUtils/rangeExtend":39,"../tableUtils/tableZone":46}],52:[function(require,module,exports){
var ENV = require('./common/env'),
...
module.exports = WizEditor;
},{"./WizEditor":5,"./WizReader":6,"./common/env":17,"./todoUtils/todoRouteForClient":48}]},{},[52]);
