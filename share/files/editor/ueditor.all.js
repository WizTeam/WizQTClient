...
UE.plugins['keystrokes'] = function() {
        ...
        if (keyCode == 8) {
            ...
            if(rng.collapsed && rng.inFillChar()){
                ...
                if(domUtils.isFillChar(start)){
                    ...
                    // Modified by Albert.Zhou
                    // Do not remove this fillchar node, this may lose cursor on Qt Webkit.
                    // just remove it should also fix double time deletion issue!!!
    ...
    me.addListener('keyup', function(type, evt) {
        ...
        // Add by Albert.Zhou: ueditor should merge text node on Qt.
        //rng = me.selection.getRange();
