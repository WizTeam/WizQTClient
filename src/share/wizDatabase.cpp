...
void CWizDocument::makeSureObjectDataExists()
{
...
bool CWizDocument::MoveTo(CWizDatabase& targetDB, CWizFolder* pFolder)
{
...
bool CWizDocument::MoveTo(CWizDatabase& targetDB, const WIZTAGDATA& targetTag)
{
