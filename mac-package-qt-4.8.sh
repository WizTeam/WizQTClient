...
cmake -DWIZNOTE_USE_QT5=NO -DCMAKE_BUILD_TYPE=Release -DQMAKE_PREFIX_PATH=/Developer/Tools/Qt/qmake ../WizQTClient && \
make -j3 && \
cd ../WizQTClient
...
if [ -e "$package_home" ]; then
	...
	cp -R ../WizQTClient-Release-QT4/wiznote.app ${package_home} && \
